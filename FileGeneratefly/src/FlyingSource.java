...
public class FlyingSource {

	
	private static final String OUTPUT_FILE = "rekvizit.pdf";
	...
	public static void generatePdf() throws Exception {
        ...
        String renderedHtmlContent = templateEngine.process("REKVIZIT_AZN", context);
    ...
    private static String convertToXhtml(String html) throws UnsupportedEncodingException {
        Tidy tidy = new Tidy();
        tidy.setCharEncoding(StandardCharsets.UTF_8.);
        tidy.setXHTML(true);
        tidy.setCharEncoding(arg0);
